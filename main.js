...
/***/ "./js/modules/control/backendBridge.js":
/*!*********************************************!*\
  !*** ./js/modules/control/backendBridge.js ***!
  \*********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return backendBridge; });\nfunction backendBridge(pagina) {\r\n  async function fetchData(url) {\r\n    const response = await fetch(url);\r\n    return await response.json();\r\n  }\r\n\r\n  const paginas = {\r\n    \"minhaconta\": () => {\r\n      return fetchData(\"http://localhost:8080/users\")\r\n    },\r\n    \"adicionarItem\": () => {\r\n      return fetchData(\"http://localhost:8080/items\")\r\n    },\r\n    \"visualizarItem\": () => {\r\n      return fetchData(\"http://localhost:8080/items\")\r\n    },\r\n    \"adicionarGrupo\": () => {\r\n      return fetchData(\"http://localhost:8080/groups\")\r\n    },\r\n    \"visualizarGrupos\": () => {\r\n      return fetchData(\"http://localhost:8080/groups\")\r\n    },\r\n    \"validarUsuario\": () => {\r\n      return fetchData(\"http://localhost:8080/users\")\r\n    },\r\n    \"visualizarUsuarios\": () => {\r\n      return fetchData(\"http://localhost:8080/users\")\r\n    }\r\n  }\r\n\r\n  return paginas[pagina]();\r\n}\n\n//# sourceURL=webpack:///./js/modules/control/backendBridge.js?");

/***/ }),

/***/ "./js/modules/control/dataHandler.js":
/*!*******************************************!*\
  !*** ./js/modules/control/dataHandler.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ItemController; });\n/* harmony import */ var _log_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../log/logger */ \"./js/modules/log/logger.js\");\n\r\n\r\nclass ItemController {\r\n  constructor(item) {\r\n    this.item = item;\r\n  }\r\n\r\n  async fetchData() {\r\n    try {\r\n      const response = await fetch(\"http://localhost:8080/items\", {\r\n        method: \"POST\",\r\n        body: JSON.stringify(this.item.toObject),\r\n        headers: {\r\n          \"content-type\": \"application/json\"\r\n        }\r\n      });\r\n\r\n      if (!response.ok) throw \"Erro ao realizar Upload dos dados\";\r\n\r\n      return await response.text();\r\n\r\n    } catch (e) {\r\n      throw new Error(e);\r\n    }\r\n  }\r\n\r\n  async fetchFile() {\r\n    try {\r\n      const dataResponse = await this.fetchData();\r\n      const id = dataResponse.split(\"/\").pop();\r\n      this.formData.append(\"id\", id);\r\n\r\n      const response = await fetch(\"http://localhost:8080/items/upload\", {\r\n        method: \"PUT\",\r\n        body: this.formData\r\n      });\r\n\r\n      if (!response.ok) throw \"Erro ao realizar Upload do arquivo\";\r\n\r\n      _log_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log(\"Upload realizado com sucesso\");\r\n\r\n    } catch (e) {\r\n      throw new Error(e);\r\n    }\r\n\r\n  }\r\n\r\n  fetchItem(formData) {\r\n    try {\r\n      if (formData != undefined) {\r\n        this.formData = formData;\r\n        this.fetchFile();\r\n      }\r\n\r\n      _log_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log(\"Form não prenchido corretamente\");\r\n    } catch (e) {\r\n      _log_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log(e);\r\n    }\r\n  }\r\n}\n\n//# sourceURL=webpack:///./js/modules/control/itemController.js?");

/***/ }),

/***/ "./js/modules/control/pageHandler.js":
/*!*******************************************!*\
  !*** ./js/modules/control/pageHandler.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return PageHandler; });\n/* harmony import */ var _view_replaceHtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/replaceHtml */ \"./js/modules/view/replaceHtml.js\");\n/* harmony import */ var _log_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../log/logger */ \"./js/modules/log/logger.js\");\n/* harmony import */ var _model_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/item */ \"./js/modules/model/item.js\");\n/* harmony import */ var _itemController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./itemController */ \"./js/modules/control/itemController.js\");\n\r\n\r\n\r\n\r\n\r\nclass PageHandler {\r\n  constructor(pageHtml, url, backendData) {\r\n    this.replaceHtml = new _view_replaceHtml__WEBPACK_IMPORTED_MODULE_0__[\"default\"](pageHtml);\r\n    this.page = this.getPage(url);\r\n    this.backendData = backendData;\r\n\r\n    this.pages = {\r\n      \"minhaconta\": () => {\r\n        this.replaceHtml.init();\r\n      },\r\n      \"adicionarItem\": () => {\r\n        this.replaceHtml.init();\r\n\r\n        const dataForm = document.querySelector(\"[data-form='adicionar_item']\");\r\n        dataForm.addEventListener('submit', (event) => {\r\n          event.preventDefault();\r\n          const myFile = document.querySelector('[data-input=\"file\"]');\r\n          const restricoes = document.querySelector('[data-input=\"restricoes\"]');\r\n\r\n          if (myFile.files.length != 0) {\r\n            const item = new _model_item__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n            item.setNome(myFile.files[0].name);\r\n            item.setRestricoes(restricoes.value);\r\n            item.setTipo(myFile.files[0].type);\r\n\r\n            const itemController = new _itemController__WEBPACK_IMPORTED_MODULE_3__[\"default\"](item);\r\n            itemController.fetchItem(new FormData(dataForm));\r\n          } else {\r\n            _log_logger__WEBPACK_IMPORTED_MODULE_1__[\"default\"].log(\"Arquivo não selecionado.\");\r\n          }\r\n        })\r\n      },\r\n      \"visualizarItem\": () => {\r\n        this.replaceHtml.replaceHtmlWithBackendData(this.backendData, this.page);\r\n        this.replaceHtml.init();\r\n      },\r\n      \"adicionarGrupo\": () => {\r\n        this.replaceHtml.init();\r\n      },\r\n      \"visualizarGrupos\": () => {\r\n        this.replaceHtml.replaceHtmlWithBackendData(this.backendData, this.page);\r\n        this.replaceHtml.init();\r\n      },\r\n      \"validarUsuario\": () => {\r\n        this.replaceHtml.replaceHtmlWithBackendData(this.backendData, this.page);\r\n        this.replaceHtml.init();\r\n      },\r\n      \"visualizarUsuarios\": () => {\r\n        this.replaceHtml.replaceHtmlWithBackendData(this.backendData, this.page);\r\n        this.replaceHtml.init();\r\n      }\r\n    }\r\n  }\r\n\r\n  getPage(url) {\r\n    const page = url.split(\"/\")[3];\r\n    return page.split(\".\")[0];\r\n  }\r\n\r\n  init() {\r\n    this.pages[this.page]();\r\n  }\r\n}\n\n//# sourceURL=webpack:///./js/modules/control/pageHandler.js?");

/***/ }),

/***/ "./js/modules/log/logger.js":
/*!**********************************!*\
  !*** ./js/modules/log/logger.js ***!
  \**********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ModalMenu; });\n/* harmony import */ var _buttons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./buttons */ \"./js/modules/view/buttons.js\");\n/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements */ \"./js/modules/view/elements.js\");\n\r\n\r\n\r\nclass ModalMenu {\r\n  constructor(selector) {\r\n    if (selector === undefined) this.selector = '[data-button=\"sign-up\"]';\r\n    else this.selector = selector;\r\n\r\n    this.button = new _buttons__WEBPACK_IMPORTED_MODULE_0__[\"default\"](this.selector);\r\n    this.menu = new _elements__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('[data-modal=\"sign-up\"]');\r\n    this.container = document.querySelector('[data-modal=\"container\"');\r\n\r\n    this.open = this.open.bind(this);\r\n    this.close = this.close.bind(this);\r\n  }\r\n\r\n  open(event) {\r\n    event.preventDefault();\r\n    this.menu.toggle();\r\n  }\r\n\r\n  close(event) {\r\n    event.preventDefault();\r\n    if (event.target === this.menu.element) this.menu.toggle();\r\n  }\r\n\r\n  addEvents() {\r\n    this.button.addEventListenerToButtons((button) => {\r\n      button.addEventListener('click', this.open);\r\n    })\r\n    this.menu.addClick(this.close);\r\n  }\r\n\r\n  init() {\r\n    if (this.menu.element != null) this.addEvents();\r\n  }\r\n}\n\n//# sourceURL=webpack:///./js/modules/view/modalMenu.js?");

/***/ }),

/***/ "./js/modules/view/pageSelector.js":
/*!*****************************************!*\
  !*** ./js/modules/view/pageSelector.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initPageSelector; });\n/* harmony import */ var _asideMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./asideMenu */ \"./js/modules/view/asideMenu.js\");\n/* harmony import */ var _control_pageHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../control/pageHandler */ \"./js/modules/control/pageHandler.js\");\n/* harmony import */ var _loading_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./loading_animation */ \"./js/modules/view/loading_animation.js\");\n/* harmony import */ var _buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./buttons */ \"./js/modules/view/buttons.js\");\n/* harmony import */ var _control_backendBridge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../control/backendBridge */ \"./js/modules/control/backendBridge.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nfunction initPageSelector() {\r\n  async function fetchPage(url) {\r\n    const response = await fetch(url);\r\n    const pageHtml = await response.text();\r\n    const backendData = await Object(_control_backendBridge__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(getPage(url));\r\n    const pageHandler = new _control_pageHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"](pageHtml, url, backendData);\r\n    pageHandler.init();\r\n    asideMenu.attAsideDisplay(getPage(url));\r\n  }\r\n\r\n  function getPage(url) {\r\n    const page = url.split(\"/\")[3];\r\n    return page.split(\".\")[0];\r\n  }\r\n\r\n  function handleClick(event) {\r\n    event.preventDefault();\r\n    Object(_loading_animation__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\r\n    // window.history.pushState(null, null, event.target.href);\r\n    fetchPage(event.target.href);\r\n  }\r\n\r\n  // window.addEventListener('popstate', () => {\r\n  //   fetchPage(window.location.href);\r\n  // })\r\n\r\n  const asideMenu = new _asideMenu__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\r\n  const buttons = new _buttons__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('[data-link]');\r\n  buttons.addEventListenerToButtons((button) => {\r\n    button.addEventListener('click', handleClick);\r\n  });\r\n}\n\n//# sourceURL=webpack:///./js/modules/view/pageSelector.js?");

/***/ }),

/***/ "./js/modules/view/replaceHtml.js":
/*!****************************************!*\
  !*** ./js/modules/view/replaceHtml.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_view_pageSelector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/view/pageSelector */ \"./js/modules/view/pageSelector.js\");\n/* harmony import */ var _modules_view_modalMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/view/modalMenu */ \"./js/modules/view/modalMenu.js\");\n\r\n\r\n\r\nwindow.onload = _modules_view_pageSelector__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\r\n\r\nconst modalMenu = new _modules_view_modalMenu__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\nmodalMenu.init();\n\n//# sourceURL=webpack:///./js/script.js?");
